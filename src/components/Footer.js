      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col size={12} sm={6}>
            ...
            <p className="nk brand-text">NK</p>
          </Col>
          <Col size={12} sm={6} className="text-center text-sm-end">
            <div className="social-icon">
              <a href="https://www.linkedin.com/in/nandini-khokhani-aa59b8178" target="_blank" rel="noopener noreferrer"><img src={navIcon1} alt="Icon" /></a>
